...
<head>
    ...
    <style>
        ...
        .error { color: red; }
        .success { color: green; }
        .log { background: #000; color: #0f0; padding: 10px; margin: 10px 0; border-radius: 5px; font-family: monospace; max-height: 300px; overflow-y: auto; }
    </style>
</head>
<body>
    <h1>Real-Time Data Service Test</h1>
    ...
    <div class="test-section">
        <h3>Manual Test</h3>
        <button onclick="testRealtimeData()">Test Real-Time Data</button>
    ...
    <script>
        ...
        window.onload = function() {
            log('Page loaded. Testing real-time data service...');
            if ({{ Auth::check() ? 'true' : 'false' }}) {
                log('User is authenticated. Testing endpoints...', 'success');
                // Auto-test the endpoints
                setTimeout(() => {
                    testActiveModules();
                }, 1000);
                setTimeout(() => {
