...
@section('title', 'Radiology Purchases')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
            <h1 class="h3 mb-1" style="color: #1e3a5f;"><i class="bi bi-file-medical"></i> Radiology Supplies Purchases</h1>
            <p class="text-secondary mb-0">Purchase contrast, films, and consumables — separate from pharmacy and lab</p>
        </div>
        @can('create_radiology_purchases')
        <a href="{{ route('radiology.purchases.create') }}" class="btn btn-primary">
            ...
            <table class="table table-hover mb-0">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-end">
                            <a href="{{ route('radiology.purchases.show', $order) }}" class="btn btn-sm btn-outline-primary">View</a>
                        </td>
                    </tr>
                    @empty
                    <tr><td colspan="7" class="text-center text-muted py-4">No radiology purchase orders yet.</td></tr>
                    @endforelse
                </tbody>
            </table>
        </div>
