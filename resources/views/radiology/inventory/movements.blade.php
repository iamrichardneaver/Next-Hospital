...
@section('title', 'Radiology Inventory Movements')

@section('content')
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4 flex-wrap gap-2">
        <div>
            <h1 class="h3 mb-1" style="color: #1e3a5f;"><i class="bi bi-clock-history"></i> Radiology Stock Movements</h1>
            <p class="text-secondary mb-0">Audit trail of receipts, study consumption, and adjustments</p>
        </div>
        <a href="{{ route('radiology.inventory.index') }}" class="btn btn-outline-secondary btn-sm">Back to Inventory</a>
    </div>
            ...
            <form method="GET" class="row g-3">
                <div class="col-md-4">
                    <select name="movement_type" class="form-select">
                        ...
                        @foreach(['purchase_receipt','study_consumption','consumption_reversal','adjustment','waste'] as $type)
