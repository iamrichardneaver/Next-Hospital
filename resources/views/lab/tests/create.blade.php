...
<div class="container-fluid">
    <div class="mb-4">
        <h1 class="h3 mb-1" style="color: #1e3a5f;">Create Individual Test</h1>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 text-dark">New Laboratory Test</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('lab.tests.store') }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        @enderror
                        <small class="text-muted">Unique code (e.g., TEST-CBC-001)</small>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select @error('test_type_id') is-invalid @enderror" 
                                id="test_type_id" name="test_type_id" disabled>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" class="form-control @error('turnaround_hours') is-invalid @enderror" 
                               id="turnaround_hours" name="turnaround_hours" value="{{ old('turnaround_hours', 24) }}" min="1">
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const originalTestTypes = Array.from(testTypeSelect.options).map(opt => ({
        value: opt.value,
        text: opt.text,
        categoryId: opt.dataset.categoryId
    }));
    
    // Function to filter test types based on category
    function filterTestTypes(categoryId) {
        ...
        if (!categoryId) {
            ...
            originalTestTypes.forEach(type => {
                if (type.value) {
    ...
    categorySelect.addEventListener('change', function() {
        ...
        filterTestTypes(selectedCategoryId);
    });
    
    // Trigger on page load if category is pre-selected (for edit mode)
    if (categorySelect.value) {
        filterTestTypes(categorySelect.value);
    }
});
</script>
@endpush
