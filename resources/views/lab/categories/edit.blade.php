...
<div class="container-fluid">
    <div class="mb-4">
        <h1 class="h3 mb-1" style="color: #1e3a5f;">Edit Test Category</h1>
    ...
    <div class="card">
        <div class="card-header">
            <h5 class="mb-0 text-dark">Edit Category: {{ $category->name }}</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('lab.categories.update', $category) }}" method="POST">
                @csrf
                @method('PUT')
