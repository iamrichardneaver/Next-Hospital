...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .header, .receipt-title, .receipt-info, .items-section, 
            .totals-section, .payment-section, .thank-you, .footer {
                break-inside: avoid;
            }
        }
...
<body class="thermal-print {{ $options['printer_width'] === '58mm' ? 'thermal-58mm' : '' }}">
    ...
    <!-- Receipt Information -->
    <div class="receipt-info-thermal">
    ...
    <div class="thank-you">
        ...
        <span style="font-size: 9px;">Please keep this receipt</span>
    </div>
